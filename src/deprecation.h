...
static const int APPROX_RELEASE_HEIGHT = 1384313;
...
static_assert(EXPECTED_BLOCKS_PER_HOUR == 120, "The value of Consensus::POST_BLOSSOM_POW_TARGET_SPACING was chosen such that this assertion holds.");
