...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Zcash vect-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  vect-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vect transaction") + "\n" +
              "  vect-tx [options] -create [commands]   " + _("Create hex-encoded vect transaction") + "\n" +
              "\n";
